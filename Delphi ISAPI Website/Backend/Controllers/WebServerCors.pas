...
uses Controller, Web.WebReq;

procedure TWebModule1.DSServerClass1GetClass(
  DSServerClass: TDSServerClass; var PersistentClass: TPersistentClass);
begin
  PersistentClass := Controller.TServerMethods1;
end;
...
begin
  if SameText(TagString, 'urlpath') then
    ...
    ReplaceText := Controller.TServerMethods1.ClassName
    ...
    if AllowServerFunctionInvoker then
      ...
      '<div><a href="' + string(Request.InternalScriptName) +
      'Frontend/index.html" target="_blank">Go To Frontend Web Site</a></div>'
    else
      ReplaceText := '';
end;
...
begin
   ...
   Response.SetCustomHeader('Access-Control-Allow-Methods', 'GET,PUT,POST,DELETE');
   Response.SetCustomHeader('Access-Control-Allow-Headers','Content-Type,X-Your-Extra-Header-Key');
