...
function TServerMethods1(connectionInfo)
{
  ...
  this.HelloWorld = function() {
    var returnObject = this.executor.executeMethod('HelloWorld', "GET", [], arguments[0], true, arguments[1], arguments[2]);
    if (arguments[0] == null) {
      if (returnObject != null && returnObject.result != null && isArray(returnObject.result)) {
        var resultArray = returnObject.result;
        var resultObject = new Object();
  ...
  this.HelloWorld_URL = function() {
    return this.executor.getMethodURL("HelloWorld", "GET", [], arguments[0])[0];
  };

  /*
   * @return result - Type on server: TList<User.TUser>
   */
  ...
  this.GetUserList_URL = function() {
    return this.executor.getMethodURL("GetUserList", "GET", [], arguments[0])[0];
  };
  ...
  this.GetUserListFromDb = function() {
    var returnObject = this.executor.executeMethod('GetUserListFromDb', "GET", [], arguments[0], true, arguments[1], arguments[2]);
    if (arguments[0] == null) {
      if (returnObject != null && returnObject.result != null && isArray(returnObject.result)) {
        var resultArray = returnObject.result;
        var resultObject = new Object();
  ...
  this.GetUserListFromDb_URL = function() {
    return this.executor.getMethodURL("GetUserListFromDb", "GET", [], arguments[0])[0];
  };

  /*
   * @param newUser [in] - Type on server: TUser
   * @return result - Type on server: string
   */
  this.AddNewUser = function(newUser) {
    var returnObject = this.executor.executeMethod('"AddNewUser"', "POST", [newUser], arguments[1], true, arguments[2], arguments[3]);
    if (arguments[1] == null) {
      if (returnObject != null && returnObject.result != null && isArray(returnObject.result)) {
        var resultArray = returnObject.result;
        var resultObject = new Object();
        resultObject.newUser = newUser;
        resultObject.result = resultArray[0];
        return resultObject;
      }
      return returnObject;
...
var JSProxyClassList = {
  ...
  "TServerMethods1": ["HelloWorld","GetUserList","GetUserListFromDb","AddNewUser"]
};
